...
<body>
    ...
    <div class="line"></div>
    <div class="subtitle">
        You are connected to the Project 3 Enterprise System database as a <span style="color: red;">client-level</span> user.<br>
        Please enter any SQL query in the box below.
    </div>
